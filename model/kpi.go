...
type Monthly struct{
	Monthly_ID 		int			`gorm:"primaryKey;autoIncrement;unique_index" json:"Monthly_ID"`	
...
type Attendance struct{
	Year 		int			`gorm:"primaryKey;unique_index" json:"Year"`
...
type MiniPAP struct{
	MiniPAP_ID	int			`gorm:"primaryKey;autoIncrement;unique_index" json:"Minipap_ID"`
	Monthly		[]Monthly	`gorm:"foreignKey:MinipapID;constraint:OnUpdate:CASCADE,OnDelete:SET NULL" json:"Monthly"`
}

type Factor struct{
	Factor_ID	int			`gorm:"primaryKey;autoIncrement;unique_index" json:"Factor_ID"`
...
type Result struct{
	Result_ID	int				`gorm:"primaryKey;autoIncrement;unique_index" json:"Result_ID"`
...
type Item struct{
	Item_ID		int				`gorm:"primaryKey;autoIncrement;unique_index" json:"Item_ID"`
	Name		string			`gorm:"notNull" json:"Name"`
...
type Masalah struct{
	Masalah_ID		int				`gorm:"primaryKey;autoIncrement;unique_index" json:"Masalah_ID"`
...
type Project struct{
	Project_ID		int				`gorm:"primaryKey;autoIncrement;unique_index"`
	Name 			string			`gorm:"notNull" json:"Name"`
	Summary_ID		*int					
	INYS			int
	QNYS			int
...
type Summary struct{
	Summary_ID		int			`gorm:"primaryKey;autoIncrement;unique_index"`
